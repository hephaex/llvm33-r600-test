...
define void @_Z6kernelPU3AS1fPKU3AS1fS2_(float addrspace(1)* noalias %c, float addrspace(1)* noalias %a, float addrspace(1)* noalias %b) #0 {
...
declare i32 @blockIdx_x() #1

declare i32 @blockDim_x() #1

declare i32 @threadIdx_x() #1
